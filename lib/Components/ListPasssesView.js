...
const ListPasssesView = ({ data = [], type = "", selectedItem, key = 0,navigation,all =false }) => {
console.log(data,all,"I receive");
  return (
    <TouchableOpacity
      key={key}
    ...
    >
      ...
      >
        ...
        <View style={{ flex: 1, padding: 25 }}>
          ...
          onPress={()=>{
            if(all){
              navigation.navigate("Passesparkings",{pass_id:data?.id})
            }else{
