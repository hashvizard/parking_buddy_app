...
const ExtendBooking = ({ data, navigation, updateData }) => {
  ...
  return (
    <View style={{}}>
      ...
      <View  style={{borderWidth:1,marginVertical:4,borderColor:colors.appColor}} />
      <View
        style={{
          backgroundColor: colors.greyText,
          padding: 10,
      ...
      >
        ...
        >
          <Text style={{ color: colors.darkGreen, fontSize: 15 }}>Duration</Text>
          <Text style={{ color: colors.darkGreen, fontSize: 15 }}>{duration} Hours</Text>
        </View>
        ...
        >
          <Text style={{ color:colors.darkGreen, fontSize: 15 }}>Sub-Total</Text>
        ...
        >
          <Text style={{ color:colors.darkGreen, fontWeight: "bold", fontSize: 23 }}>
            Total
          </Text>
          <Text style={{ color: colors.darkGreen, fontSize: 15, fontWeight: "bold" }}>
            ₹ {rate * duration}
          </Text>
        </View>
        <TouchableOpacity
