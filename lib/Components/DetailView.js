...
import { dateFormatChanger, getTimeFrame, getTimeFrameOnly } from "../../src/helpers";
import ScooterYellowIcon from "../../assets/svg/bikeyellow.svg";
import CarIcon from "../../assets/svg/Car.svg";
import Button from "./Button";
import PressButton from "./PressButton";
import { emptyUserBookingData, setEnabledHome, showBottomSheetContainer } from "../../src/redux/actions";
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <View style={{ flexGrow: 1,display:"flex",flexDirection:"row",justifyContent:"space-between" }}>
                <View >
                ...
                >
                  {getTimeFrameOnly(selectedTime, time_duration)}
                </Text>
                <View
                  style={{
                    marginTop: 5,
