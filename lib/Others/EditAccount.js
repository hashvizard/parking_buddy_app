...
import { emptyUserSignupData, loadingState, setUserBackendData, setUserData } from "../../src/redux/actions";
...
const EditAccount = ({ navigation }) => {
  ...
  return (
    <Container>
      ...
      >
        <ProfileEditForm userData={userData} backendError={backendError} setBackendError={(data)=>setBackendError(data)} />
      </Formik>
    </Container>
  );
};
