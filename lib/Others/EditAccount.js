...
const EditAccount = ({ navigation }) => {
  ...
  const handleProfileSubmission = async (values) => {
    let formatedData = {
      name: `${
        values?.first_name && values?.first_name != 'null'  && values?.first_name != null 
                  ? values?.first_name
          : parseDisplayName(userData?.name)?.firstName
      } ${
        values?.last_name && values?.last_name != 'null' && values?.last_name != null  ? values?.last_name : parseDisplayName(userData?.name)
      }`,
      phone: values?.mobile_number && values?.mobile_number != 'null' && values?.mobile_number != null  ? values?.mobile_number : userData?.phone,
      email: values?.email_address && values?.email_address != 'null' && values?.email_address != null ? values?.email_address : userData?.email,
    };
