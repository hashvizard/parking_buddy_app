...
const Legal = ({ navigation }) => {
  return (
    <Container>
      ...
      <TouchableOpacity
        onPress={() => {
          navigation.navigate("PolicyView", { type: "disclaimer" });
        }}
      >
      ...
      <TouchableOpacity
        onPress={() => {
          navigation.navigate("PolicyView", { type: "license_agreement" });
        }}
      >
        <View style={styles.item}>
      ...
      <TouchableOpacity
        onPress={() => {
          navigation.navigate("PolicyView", { type: "privacy_policy" });
        }}
      >
        <View style={styles.item}>
      ...
      <TouchableOpacity
        onPress={() => {
          navigation.navigate("PolicyView", { type: "refund_policy" });
        }}
      >
        <View style={styles.item}>
