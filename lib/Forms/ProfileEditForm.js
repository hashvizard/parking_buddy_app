...
const ProfileEditForm = ({ data = {}, userData = {},backendError, setBackendError }) => {
  ...
  useEffect(() => {
    formikProps.setFieldValue("first_name", parseDisplayName(userData?.name)?.firstName);
    formikProps.setFieldValue("last_name", parseDisplayName(userData?.name)?.lastName);
      ...
      <View style={styles.form_container}>
        <View style={styles.form_inputWrap}>
          <TextInput
            ...
            placeholder={parseDisplayName(userData?.name)?.firstName}
          ...
          <TextInput
            ...
            placeholder={parseDisplayName(userData?.name)?.lastName}
          />
        </View>
        <View style={styles.form_inputWrap}>
          <TextInput
