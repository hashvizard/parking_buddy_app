import {LOGGED_IN, RESET_SIGNUP, SET_ALERT,EMPTY_NOTIFICATION, SET_NOTIFY, SET_BOOKING_DATA, SET_BOTTOM_SHEET_INDEX, SET_ENABLED_HOME, SET_INTIAL_BOOKING_DATA, SET_LOADING, SET_MAP_DATA, SET_NOTIFICATIONS, SET_NOTIFICATION_SEEN, SET_USER_DATA, SET_USER_VEHICLE_DATA, SHOW_BOTTOM_SHEET, USER_DATA} from '../constants';
...
// Setting user Backend Data
export const setNotify = state => dispatch => {
  return dispatch({
    data: state,
    type: SET_NOTIFY,
  });
...
// Setting Notifications Seen
export const setNotificationEmpty = seen => dispatch => {
  return dispatch({
